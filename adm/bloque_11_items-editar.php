...
$consulta=mysqli_fetch_array(mysqli_query($link,"select * from bloque_11_items where id=".$_GET["id"].""));
...
<head>
	<meta charset="utf-8" />
	<title>bloque_11_items editar</title>
	...
	<div id="page-container" class="page-header-fixed page-sidebar-fixed">
		...
		<div id="content" class="content">
			...
			<ul class="breadcrumb">
				...
				<li><a href="bloque_11_items.php">bloque_11_items</a></li>
				<li class="active">bloque_11_items [Editar]</li>
			</ul>
			<!-- END breadcrumb -->
			<!-- BEGIN page-header -->
			...
			<div id="rootwizard" class="wizard wizard-full-width">
				...
				<div class="wizard-header">
					<ul class="nav nav-pills">
						<li class="active"><a href="#tab1" data-toggle="tab">bloque_11_items - EDITAR</a></li>
				...
				<!-- END wizard-header -->
				<!-- BEGIN wizard-form -->
<form action="bloque_11_items.php" method="post" enctype="multipart/form-data" onSubmit="$('#btn_editar').html('Editando ...')" name="wizard_form">
						...
						<div class="tab-pane active" id="tab1">
							...
							<div class="row">
								...
								<div class="col-md-6 col-md-offset-3">
									<p class="desc m-b-20">bloque_11_items [Editar].</p>
...
<textarea  rows="5" name="texto" id="texto" class="form-control"  ><?=$consulta["texto"]?></textarea>
									</div>										

									
									
	<div class="form-group">
										<label class="control-label">Img. Ref.</label>

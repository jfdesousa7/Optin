...
if(isset($_GET["eliminar"])){
	eliminar('valores',$_GET["eliminar"],$link); $hide2="";
}

if (isset($_POST["btn_editar"])){
	if( $_POST["estatus"]==""){$estatus="no";}else{$estatus="si";}
	
$update=mysqli_query($link,"update valores    set  estatus='".$estatus."', nombre='".$_POST["nombre"]."',nombre2='".$_POST["nombre2"]."' 	 where id=".$_POST["id"]." ") or die ("Error al editar  ");	
$hide2="";
...
if (isset($_POST["btn_guardar"])){
 ...
 mysqli_query($link,"insert into valores  values(NULL,NULL,NULL,'si')");
 $id=mysqli_insert_id($link);
	 
 $update=mysqli_query($link,"update valores    set   nombre='".$_POST["nombre"]."',nombre2='".$_POST["nombre2"]."'  where id=".$id." ") or die ("Error al guardar ");	
...
<body>
	...
	<div id="page-container" class="page-header-fixed page-sidebar-fixed">
		...
		<div id="content" class="content">
			...
			<!-- END page-header -->
			<a href="valores-nuevo.php" class="btn btn-default btn-lg">Nuevo <i class="ti-pencil"></i></a>
			...
			<table id="datatables-default" class="table table-striped table-condensed table-bordered bg-white">
				<thead>
					<tr>
						 ...
						 <th class="no-sort" style="white-space: nowrap">Subtitulo</th>
...
$sql1=mysqli_query($link,"select * from  valores ");
...
<a href="valores-editar.php?id=<?=$row1["id"]?>" class="btn btn-default btn-xs"><i class="ti-pencil"></i></a>

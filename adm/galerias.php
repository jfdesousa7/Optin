...
if(isset($_GET["eliminar"])){
	eliminar('galeria',$_GET["eliminar"],$link); $hide2="";
}

if (isset($_POST["btn_editar"])){
	if( $_POST["estatus"]==""){$estatus="no";}else{$estatus="si";}
	
$update=mysqli_query($link,"update galeria    set  estatus='".$estatus."', nombre='".$_POST["nombre"]."'	 where id=".$_POST["id"]." ") or die ("Error al editar  ");	
$hide2="";
...
if (isset($_POST["btn_guardar"])){
 ...
 mysqli_query($link,"insert into galeria  values(NULL,NULL,'si')");
 $id=mysqli_insert_id($link);
	 
 $update=mysqli_query($link,"update galeria    set   nombre='".$_POST["nombre"]."' where id=".$id." ") or die ("Error al guardar ");	
...
<body>
	...
	<div id="page-container" class="page-header-fixed page-sidebar-fixed">
		...
		<div id="content" class="content">
			...
			<!-- END page-header -->
			<a href="galerias-nuevo.php" class="btn btn-default btn-lg">Nuevo <i class="ti-pencil"></i></a>
...
$sql1=mysqli_query($link,"select * from  galeria ");
...
<a href="galerias-editar.php?id=<?=$row1["id"]?>" class="btn btn-default btn-xs"><i class="ti-pencil"></i></a>

<a href="galerias-imagenes.php?id=<?=$row1["id"]?>" class="btn btn-default btn-xs" alt="IMAGENES"><i class="ti-image"></i> Imágenes</a>

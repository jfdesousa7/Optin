...
<input  type="file" name="link_brochure" id="link_brochure" class="form-control" value="<?=$consulta["link_brochure"]?>">
</div>								
									
									<div style="padding:2%;background-color:#f2f2f2">
									<div class="form-group">
										    <label class="control-label">Icono Principal</label>
										    <input type="file" name="icono" > 
                                    </div>
									 </div>	
									<div style="padding:2%;background-color:#d6d692">
									<div class="form-group">
										    <label class="control-label">Imágen Post</label>
										    <input type="file" name="foto" > 
                                    </div>	
</div>	
									<div style="padding:2%;background-color:#f9f9f9">	
											<div class="form-group">
												<label class="control-label">Imagén Cabecera</label>

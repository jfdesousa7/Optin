...
if (isset($_POST["btn_editar"])){
	...
	if( $_POST["hide_bloque_5"]==""){$estatus="si";}else{$estatus="no";}

		$update=mysqli_query($link,"update home set 
		bloque_5_texto1='".mysqli_real_escape_string($link,$_POST["bloque_5_texto1"])."',
		bloque_5_texto2='".mysqli_real_escape_string($link,$_POST["bloque_5_texto2"])."',
		bloque_5_texto3='".mysqli_real_escape_string($link,$_POST["bloque_5_texto3"])."',
		bloque_5_texto4='".mysqli_real_escape_string($link,$_POST["bloque_5_texto4"])."',
		bloque_5_texto5='".mysqli_real_escape_string($link,$_POST["bloque_5_texto5"])."',
		bloque_5_texto6='".mysqli_real_escape_string($link,$_POST["bloque_5_texto6"])."',
		hide_bloque_5='".$estatus."'
			...
			<div id="rootwizard" class="wizard wizard-full-width">
				...
				<div class="wizard-header">
					<ul class="nav nav-pills">
						<li class="active"><a href="#tab1" data-toggle="tab">Bloque 5</a></li>
...
<div class="form-group">
	<?php  if ($row1["hide_bloque_5"]=='no'){?>   <div class="switcher switcher-success">
	<input type="checkbox" name="hide_bloque_5" id="hide_bloque_5" checked="" value="no" />
	<label for="hide_bloque_5"></label>
	</div>  <?php }else{ ?>
	 <div class="switcher switcher-success">
	<input type="checkbox" name="hide_bloque_5" id="hide_bloque_5"  value="si" />
	<label for="hide_bloque_5"></label>
	</div> <?php } ?>	
</div>		
									...
									<div class="form-group">
										<label class="control-label">bloque_5_texto1</label>
										<input type="text" class="form-control" required name="bloque_5_texto1" value="<?=$row1["bloque_5_texto1"]?>" />
									</div>
									
									<div class="form-group">
										<label class="control-label">bloque_5_texto2</label>
										<input type="text" class="form-control" required name="bloque_5_texto2" value="<?=$row1["bloque_5_texto2"]?>" />
									</div>
									
									<div class="form-group">
										<label class="control-label">bloque_5_texto3</label>
										<input type="text" class="form-control" required name="bloque_5_texto3" value="<?=$row1["bloque_5_texto3"]?>" />
									</div>
									<div class="form-group">
										<label class="control-label">bloque_5_texto4</label>
										<input type="text" class="form-control" required name="bloque_5_texto4" value="<?=$row1["bloque_5_texto4"]?>" />
									</div>
									<div class="form-group">
										<label class="control-label">bloque_5_texto5</label>
										<input type="text" class="form-control" required name="bloque_5_texto5" value="<?=$row1["bloque_5_texto5"]?>" />
									</div>
									<div class="form-group">
										<label class="control-label">bloque_5_texto6</label>
										<input type="text" class="form-control" required name="bloque_5_texto6" value="<?=$row1["bloque_5_texto6"]?>" />
									</div>

...
if(isset($_GET["eliminar"])){
	eliminar('proyectos_galeria',$_GET["eliminar"],$link); $hide2="";
}
...
if($ext!=""){		
			 	            $actual_image_name =date("H_i_s")."gal".".".strtolower($ext);
							$tmp = $_FILES['foto']['tmp_name'];
							if(move_uploaded_file($tmp, $RUTA.$actual_image_name))
								{
									mysqli_query($link,"update proyectos_galeria set foto='".$actual_image_name."'  where id=".$_POST["id"]."") ;
								  }
}else{
...
if (isset($_POST["btn_guardar"])){
	...
	mysqli_query($link,"insert into proyectos_galeria values(NULL,".$_SESSION["id_prod"].",NULL,NULL)");
...
if($ext!=""){		
							...
							if(move_uploaded_file($tmp, $RUTA.$actual_image_name))
								{
									mysqli_query($link,"update proyectos_galeria set foto='".$actual_image_name."'  where id=".$id."") ;
								  }
}else{
	$hide=""; $sms="Imagen invalida, solo formatos .jpg o .png";
	}								  
...
<head>
	<meta charset="utf-8" />
	<title>proyectos_imagenes - </title>
	...
	<div id="page-container" class="page-header-fixed page-sidebar-fixed">
		...
		<div id="content" class="content">
			...
			<ul class="breadcrumb">
				...
				<li class=""><a href="proyectos.php">Proyectos Imágenes</a></li>
				<li class="active">Proyectos Imágenes</li>
			</ul>
			<!-- END breadcrumb -->
			<!-- BEGIN page-header -->
			...
			<!-- END page-header -->
			<a href="proyectos-imagenes-nuevo.php" class="btn btn-default btn-lg">Nuevo <i class="ti-pencil"></i></a>
			
		&nbsp;&nbsp;&nbsp;&nbsp;
			<a href="proyectos-imagenes-ordenar.php" class="btn btn-default btn-lg">Ordenar Imagénes</a>
			<br><br>
			<!-- BEGIN table -->
...
$sql1=mysqli_query($link,"select * from  proyectos_galeria where id_proyecto=".$_SESSION["id_prod"]." order by orden ASC");
...
<a href="proyectos-imagenes-editar.php?id=<?=$row1["id"]?>" class="btn btn-default btn-xs"><i class="ti-pencil"></i></a>

	...
	<div id="page-container" class="page-header-fixed page-sidebar-fixed">
		...
		<div id="content" class="content">
			...
			<ul class="breadcrumb">
				...
				<li class="active">Tipo [Editar]</li>
			</ul>
			<!-- END breadcrumb -->
			<!-- BEGIN page-header -->
			...
			<div id="rootwizard" class="wizard wizard-full-width">
				...
				<div class="wizard-header">
					<ul class="nav nav-pills">
						<li class="active"><a href="#tab1" data-toggle="tab">Tipo - EDITAR</a></li>
						...
						<div class="tab-pane active" id="tab1">
							...
							<div class="row">
								...
								<div class="col-md-6 col-md-offset-3">
									<p class="desc m-b-20">Tipo [Editar].</p>
...
<input type="text" name="precio" id="precio" class="form-control" value="<?=$consulta["precio"]?>">
									</div>
									
									<div class="form-group">
										<label class="control-label">Texto</label>
<textarea type="text" name="texto" id="texto" class="form-control"  ><?=$consulta["texto"]?></textarea>
									</div>

...
<input type="text" name="nombres" id="nombres" class="form-control" value="<?=$row1["nombres"]?>">
 ...
 <div class="form-group">
   ...
   <select name="tipo_usuario" class="form-control ">
                                                                                               <option <?php if ($row1["tipo_usuario"]=='administrador'){echo "selected";} ?> value="administrador">Administrador</option>
                                                                                               <option <?php if ($row1["tipo_usuario"]=='usuario'){echo "selected";} ?> value="usuario">Usuario</option>
                                                                                            </select>
 ...
 <div class="form-group">
   ...
   <select style="visibility:hidden" name="tipo_usuario" class="form-control ">
                                                                                               <option <?php if ($row1["tipo_usuario"]=='administrador'){echo "selected";} ?> value="administrador">Administrador</option>
                                                                                               <option <?php if ($row1["tipo_usuario"]=='usuario'){echo "selected";} ?> value="usuario">Usuario</option>
                                                                                            </select>

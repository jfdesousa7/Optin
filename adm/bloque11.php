...
if (isset($_POST["btn_editar"])){
	...
	if( $_POST["hide_bloque_11"]==""){$estatus="si";}else{$estatus="no";}

		$update=mysqli_query($link,"update home set 
		bloque_11_texto1='".mysqli_real_escape_string($link,$_POST["bloque_11_texto1"])."',
			...
			<div id="rootwizard" class="wizard wizard-full-width">
				...
				<div class="wizard-header">
					<ul class="nav nav-pills">
						<li class="active"><a href="#tab1" data-toggle="tab">Bloque 11</a></li>
...
<div class="form-group">
	<?php  if ($row1["hide_bloque_11"]=='no'){?>   <div class="switcher switcher-success">
	<input type="checkbox" name="hide_bloque_11" id="hide_bloque_11" checked="" value="no" />
	<label for="hide_bloque_11"></label>
	</div>  <?php }else{ ?>
	 <div class="switcher switcher-success">
	<input type="checkbox" name="hide_bloque_11" id="hide_bloque_11"  value="si" />
	<label for="hide_bloque_11"></label>
	</div> <?php } ?>	
</div>		
									...
									<div class="form-group">
										<label class="control-label">bloque_11_texto1</label>
										<input type="text" class="form-control" required name="bloque_11_texto1" value="<?=$row1["bloque_11_texto1"]?>" />
									</div>

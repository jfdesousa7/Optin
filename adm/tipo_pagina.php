...
if(isset($_GET["eliminar"])){
	eliminar('tipo_pagina',$_GET["eliminar"],$link); $hide2="";
}

if (isset($_POST["btn_editar"])){
	if( $_POST["estatus"]==""){$estatus="no";}else{$estatus="si";}
	
		$update=mysqli_query($link,"update tipo_pagina    set 
		 estatus='".$estatus."',
		 nombre='".$_POST["nombre"]."' 
...
if (isset($_POST["btn_guardar"])){
	...
	mysqli_query($link,"insert into tipo_pagina values(NULL,NULL,NULL)");
	...
	<div id="page-container" class="page-header-fixed page-sidebar-fixed">
		...
		<div id="content" class="content">
			...
			<ul class="breadcrumb">
				...
				<li class="active">Tipo Página</li>
			</ul>
			<!-- END breadcrumb -->
			<!-- BEGIN page-header -->
			...
			<!-- END page-header -->
			<a href="tipo_pagina-nuevo.php" class="btn btn-default btn-lg">Nuevo <i class="ti-pencil"></i></a>
			...
			<table id="datatables-default" class="table table-striped table-condensed table-bordered bg-white">
				<thead>
					<tr>
						 ...
						 <th class="no-sort" style="white-space: nowrap">Tipo Página</th>
...
$sql1=mysqli_query($link,"select * from  tipo_pagina  ");
...
<a href="tipo_pagina-editar.php?id=<?=$row1["id"]?>" class="btn btn-default btn-xs"><i class="ti-pencil"></i></a>

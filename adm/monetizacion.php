...
if(isset($_GET["eliminar"])){
	eliminar('monetizacion',$_GET["eliminar"],$link); $hide2="";
}

if (isset($_POST["btn_editar"])){
	if( $_POST["estatus"]==""){$estatus="no";}else{$estatus="si";}
	
		$update=mysqli_query($link,"update monetizacion    set 
		 estatus='".$estatus."',
		 nombre='".$_POST["nombre"]."' 		 
...
if (isset($_POST["btn_guardar"])){
	...
	mysqli_query($link,"insert into monetizacion values(NULL,NULL,NULL)");
	...
	<div id="page-container" class="page-header-fixed page-sidebar-fixed">
		...
		<div id="content" class="content">
			...
			<ul class="breadcrumb">
				...
				<li class="active">Monetización</li>
			</ul>
			<!-- END breadcrumb -->
			<!-- BEGIN page-header -->
			...
			<!-- END page-header -->
			<a href="monetizacion-nuevo.php" class="btn btn-default btn-lg">Nuevo <i class="ti-pencil"></i></a>
...
$sql1=mysqli_query($link,"select * from  monetizacion  ");
...
<a href="monetizacion-editar.php?id=<?=$row1["id"]?>" class="btn btn-default btn-xs"><i class="ti-pencil"></i></a>

...
if (isset($_POST["btn_editar"])){
	...
	if( $_POST["hide_bloque_3"]==""){$estatus="si";}else{$estatus="no";}

		$update=mysqli_query($link,"update home set 
		bloque_3_texto1='".mysqli_real_escape_string($link,$_POST["bloque_3_texto1"])."',
		bloque_3_texto2='".mysqli_real_escape_string($link,$_POST["bloque_3_texto2"])."',
		
		hide_bloque_3='".$estatus."'
			...
			<div id="rootwizard" class="wizard wizard-full-width">
				...
				<div class="wizard-header">
					<ul class="nav nav-pills">
						<li class="active"><a href="#tab1" data-toggle="tab">Bloque 3</a></li>
...
<div class="form-group">
	<?php  if ($row1["hide_bloque_3"]=='no'){?>   <div class="switcher switcher-success">
	<input type="checkbox" name="hide_bloque_3" id="hide_bloque_3" checked="" value="no" />
	<label for="hide_bloque_3"></label>
	</div>  <?php }else{ ?>
	 <div class="switcher switcher-success">
	<input type="checkbox" name="hide_bloque_3" id="hide_bloque_3"  value="si" />
	<label for="hide_bloque_3"></label>
	</div> <?php } ?>	
</div>		
									...
									<div class="form-group">
										<label class="control-label">bloque_3_texto1</label>
										<input type="text" class="form-control" required name="bloque_3_texto1" value="<?=$row1["bloque_3_texto1"]?>" />
									</div>
									
									<div class="form-group">
										<label class="control-label">bloque_3_texto2</label>
										<input type="text" class="form-control" required name="bloque_3_texto2" value="<?=$row1["bloque_3_texto2"]?>" />
									</div>

...
if (isset($_POST["btn_editar"])){
	...
	if( $_POST["hide_bloque_10"]==""){$estatus="si";}else{$estatus="no";}

		$update=mysqli_query($link,"update home set 
		bloque_10_texto1='".mysqli_real_escape_string($link,$_POST["bloque_10_texto1"])."',
		bloque_10_texto2='".mysqli_real_escape_string($link,$_POST["bloque_10_texto2"])."',
		bloque_10_texto3='".mysqli_real_escape_string($link,$_POST["bloque_10_texto3"])."',
		hide_bloque_10='".$estatus."'
			...
			<div id="rootwizard" class="wizard wizard-full-width">
				...
				<div class="wizard-header">
					<ul class="nav nav-pills">
						<li class="active"><a href="#tab1" data-toggle="tab">Bloque 10</a></li>
...
<div class="form-group">
	<?php  if ($row1["hide_bloque_10"]=='no'){?>   <div class="switcher switcher-success">
	<input type="checkbox" name="hide_bloque_10" id="hide_bloque_10" checked="" value="no" />
	<label for="hide_bloque_10"></label>
	</div>  <?php }else{ ?>
	 <div class="switcher switcher-success">
	<input type="checkbox" name="hide_bloque_10" id="hide_bloque_10"  value="si" />
	<label for="hide_bloque_10"></label>
	</div> <?php } ?>	
</div>		
									...
									<div class="form-group">
										<label class="control-label">bloque_10_texto1</label>
										<input type="text" class="form-control" required name="bloque_10_texto1" value="<?=$row1["bloque_10_texto1"]?>" />
									</div>
									
									<div class="form-group">
										<label class="control-label">bloque_10_texto2</label>
										<input type="text" class="form-control" required name="bloque_10_texto2" value="<?=$row1["bloque_10_texto2"]?>" />
									</div>
									
									<div class="form-group">
										<label class="control-label">bloque_10_texto3</label>
										<input type="text" class="form-control" required name="bloque_10_texto3" value="<?=$row1["bloque_10_texto3"]?>" />
									</div>

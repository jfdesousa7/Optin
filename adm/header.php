<?php $informativos=mysqli_fetch_array(mysqli_query($link,"select * from _informativos where id=1"));  if(!$_SESSION["id_usuario_ADM"]){?> <script>window.location.href='/adm/';</script><?php } ?>
			...
			<div class="container-fluid">
				...
				<div class="navbar-header">
					<a href="index.php" class="navbar-brand">
					    <i class="ti-pencil navbar-logo"></i>
					    <?=$informativos["nombre_pagina"]?>
					</a>

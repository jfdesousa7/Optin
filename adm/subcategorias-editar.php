...
$consulta=mysqli_fetch_array(mysqli_query($link,"select * from subcategorias where id=".$_GET["id"].""));
...
<ul class="nav nav-tabs" id="nav-tabs">
					...
					<li class=""><a href="#es" data-toggle="tab" aria-expanded="true">Datos </a></li>
...
<select required name="id_categoria" class="form-control">
 ...
 <?php  $mn=mysqli_query($link,"select * from categorias where   estatus='si'");

   while($rt=mysqli_fetch_array($mn)){?>
   
   
   <option <?php if($consulta["id_categoria"]==$rt["id"]){echo "selected";} ?>  value="<?=$rt["id"]?>"><?=ucfirst(strtolower($rt["nombre"]))?></option>

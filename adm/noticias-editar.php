...
$consulta=mysqli_fetch_array(mysqli_query($link,"select * from noticias where id=".$_GET["id"].""));
	...
	<div id="page-container" class="page-header-fixed page-sidebar-fixed">
		...
		<div id="content" class="content">
			...
			<ul class="breadcrumb">
				...
				<li class="active">Noticias [Editar]</li>
			</ul>
			<!-- END breadcrumb -->
			<!-- BEGIN page-header -->
			...
			<div id="rootwizard" class="wizard wizard-full-width">
				...
				<div class="wizard-header">
					<ul class="nav nav-pills">
						<li class="active"><a href="#tab1" data-toggle="tab">Noticias - EDITAR</a></li>
				...
				<!-- END wizard-header -->
				<!-- BEGIN wizard-form -->
<form action="noticias.php" method="post" enctype="multipart/form-data" onSubmit="$('#btn_editar').html('Editando ...')" name="wizard_form">
						...
						<div class="tab-pane active" id="tab1">
							...
							<div class="row">
								...
								<div class="col-md-6 col-md-offset-3">
									<p class="desc m-b-20">Noticias [Editar].</p>
...
<label class="control-label">Tipo</label>
  ...
  <option value="" >Seleccione ...</option>
				 <option value="noticia" <?php   if($consulta["tipo"]=='noticia'){echo "selected";} ?>>Noticia</option>
				 <option value="boletin" <?php   if($consulta["tipo"]=='boletin'){echo "selected";} ?>>Boletin</option>
				 <option value="video" <?php   if($consulta["tipo"]=='video'){echo "selected";} ?>>Video</option>
...
<ul class="nav nav-tabs" id="nav-tabs">
								<li class="active"><a href="#no" data-toggle="tab" aria-expanded="true">Noticia</a></li>
								<li class=""><a href="#bo" data-toggle="tab" aria-expanded="true">Boletin</a></li>
								<li class=""><a href="#vi" data-toggle="tab" aria-expanded="true">Video</a></li>
								...
								<div class="tab-content tab-content-bordered">
								<!-- BEGIN tab-pane -->
								<div class="tab-pane fade active in" id="no">
...
<textarea type="text" name="texto" id="texto" class="form-control summernote" rows="6" ><?=$consulta["texto"]?></textarea>
									</div>										
<div class="form-group">
...
<input type="file" name="foto" > 
								...
								<div class="tab-pane " id="vi">
									...
									<div class="form-group">
										<label class="control-label">Video (youtube embed)</label>
<input type="text" name="video" id="video" class="form-control" value="<?=$consulta["video"]?>">
									</div>

...
$consulta=mysqli_fetch_array(mysqli_query($link,"select * from proyectos_items where id=".$_GET["id"].""));
...
<head>
	<meta charset="utf-8" />
	<title>proyectos_items editar</title>
	...
	<div id="page-container" class="page-header-fixed page-sidebar-fixed">
		...
		<div id="content" class="content">
			...
			<ul class="breadcrumb">
				...
				<li><a href="proyectos-items.php">Proyectos items</a></li>
				<li class="active">Proyectos items [Editar]</li>
			</ul>
			<!-- END breadcrumb -->
			<!-- BEGIN page-header -->
			...
			<div id="rootwizard" class="wizard wizard-full-width">
				...
				<div class="wizard-header">
					<ul class="nav nav-pills">
						<li class="active"><a href="#tab1" data-toggle="tab">Proyectos items - EDITAR</a></li>
				...
				<!-- END wizard-header -->
				<!-- BEGIN wizard-form -->
<form action="proyectos-items.php" method="post" enctype="multipart/form-data" onSubmit="$('#btn_editar').html('Editando ...')" name="wizard_form">
						...
						<div class="tab-pane active" id="tab1">
							...
							<div class="row">
								...
								<div class="col-md-6 col-md-offset-3">
									<p class="desc m-b-20">Proyectos items [Editar].</p>
...
<li class="active"><a href="#ca" data-toggle="tab" aria-expanded="true">Items</a></li>

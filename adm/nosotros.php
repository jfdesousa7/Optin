...
if (isset($_POST["btn_editar"])){
		...
		$update=mysqli_query($link,"update _informativos set 
		 ...
		 nosotros='".limpiar($link,$_POST["nosotros"])."',
		mision='".limpiar($link,$_POST["mision"])."',
		vision='".limpiar($link,$_POST["vision"])."'
			...
			<div id="rootwizard" class="wizard wizard-full-width">
				...
				<div class="wizard-header">
					<ul class="nav nav-pills">
						<li class="active"><a href="#tab1" data-toggle="tab">Nosotros</a></li>
							...
							<div class="row">
								...
								<div class="col-md-6 col-md-offset-3">
									...
									<div class="form-group">
										<label class="control-label">Nosotros</label>
										  <textarea     name="nosotros"  class="form-control summernote"   style="height:350px"><?=$row1["nosotros"]?></textarea>
									</div>
									
																		
									<div class="form-group">
										<label class="control-label">Misión</label>
										  <textarea     name="mision"  class="form-control summernote"   style="height:350px"><?=$row1["mision"]?></textarea>
									</div>
									
																		
									<div class="form-group">
										<label class="control-label">Visión</label>
										  <textarea     name="vision" class="form-control summernote"   style="height:350px"><?=$row1["vision"]?></textarea>
									</div>
									
									<style>
									.note-editable{height:250px}
									</style>					

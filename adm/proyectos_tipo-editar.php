...
$consulta=mysqli_fetch_array(mysqli_query($link,"select * from proyectos_tipo where id=".$_GET["id"].""));
	...
	<div id="page-container" class="page-header-fixed page-sidebar-fixed">
		...
		<div id="content" class="content">
			...
			<ul class="breadcrumb">
				...
				<li><a href="proyectos_tipo.php">Proyectos</a></li>
			...
			<div id="rootwizard" class="wizard wizard-full-width">
				...
				<!-- END wizard-header -->
				<!-- BEGIN wizard-form -->
<form action="proyectos_tipo.php" method="post" enctype="multipart/form-data" onSubmit="$('#btn_editar').html('Editando ...')" name="wizard_form">

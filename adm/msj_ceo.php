...
if (isset($_POST["btn_editar"])){
		...
		$update=mysqli_query($link,"update _informativos set 
		 ...
		 rse_ceo='".limpiar($link,$_POST["rse_ceo"])."'
		where id=".$_POST["id"]."
	...
	<div id="page-container" class="page-header-fixed page-sidebar-fixed">
		...
		<div id="content" class="content">
			...
			<ul class="breadcrumb">
				...
				<li class="active">RSE - MENSAJE CEO</li>
			</ul>
			<!-- END breadcrumb -->
			<!-- BEGIN page-header -->
			...
			<div id="rootwizard" class="wizard wizard-full-width">
				...
				<div class="wizard-header">
					<ul class="nav nav-pills">
						<li class="active"><a href="#tab1" data-toggle="tab">RSE</a></li>
							...
							<div class="row">
								...
								<div class="col-md-6 col-md-offset-3">
									...
									<div class="form-group">
										<label class="control-label">RSE - MENSAJE CEO</label>
										  <textarea     name="rse_ceo"  class="form-control summernote"   style="height:350px"><?=$row1["rse_ceo"]?></textarea>
									</div>

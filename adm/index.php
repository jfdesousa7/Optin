...
if (array_key_exists("cerrar", $_GET)) {
    ...
    session_destroy();
   ?><script>window.location.href='/adm/';</script><?php
}
    ...
    position: fixed;
			...
			<div class="login-content">
				...
				<div class="login-brand">
					<a href="#" style="font-size:18px"> <?=$informativos["nombre_pagina"]?></a>
				</div>
				<!-- END login-brand -->
				<!-- BEGIN login-desc -->
				...
				<form action="<?=$_SERVER["PHP_SELF"]?>" method="POST" name="login_form">
					...
					<div class="m-b-10">
						<div class="checkbox-inline">
							<input type="checkbox" id="login-remember-me" value="2"> <label for="login-remember-me">Recordar</label>
						</div>
					</div>
				...
				<div class="alert alert-danger alert-dark <?=$hide?>">
							...
							<strong>Error!</strong>  al iniciar sesion , pruebe nuevamente
						</div>

...
if (isset($_POST["btn_editar"])){
		...
		bloque_0_texto1='".mysqli_real_escape_string($link,$_POST["bloque_0_texto1"])."',
		bloque_0_texto2='".mysqli_real_escape_string($link,$_POST["bloque_0_texto2"])."',
		bloque_0_texto3='".mysqli_real_escape_string($link,$_POST["bloque_0_texto3"])."',
		bloque_0_youtube='".mysqli_real_escape_string($link,$_POST["bloque_0_youtube"])."'
			...
			<div id="rootwizard" class="wizard wizard-full-width">
				...
				<div class="wizard-header">
					<ul class="nav nav-pills">
						<li class="active"><a href="#tab1" data-toggle="tab">PORTADA [Bloque 0]</a></li>
							...
							<div class="row">
								...
								<div class="col-md-11 col-md-offset-1">
									...
									<div class="form-group">
										<label class="control-label">bloque_0_texto1</label>
										<input type="text" class="form-control" required name="bloque_0_texto1" value="<?=$row1["bloque_0_texto1"]?>" />
									</div>
									
									<div class="form-group">
										<label class="control-label">bloque_0_texto2</label>
										<input type="text" class="form-control" required name="bloque_0_texto2" value="<?=$row1["bloque_0_texto2"]?>" />
									</div>
									
									<div class="form-group">
										<label class="control-label">bloque_0_texto3</label>
										<input type="text" class="form-control" required name="bloque_0_texto3" value="<?=$row1["bloque_0_texto3"]?>" />
									</div>
									
									
									<div class="form-group">
										<label class="control-label">bloque_0_youtube</label>
										<input type="text" class="form-control" required name="bloque_0_youtube" value="<?=$row1["bloque_0_youtube"]?>" />
									</div>

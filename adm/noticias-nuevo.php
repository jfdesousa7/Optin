	...
	<div id="page-container" class="page-header-fixed page-sidebar-fixed">
		...
		<div id="content" class="content">
			...
			<ul class="breadcrumb">
				...
				<li class="active">Noticias [Nuevo]</li>
			</ul>
			...
			<div id="rootwizard" class="wizard wizard-full-width">
				...
				<div class="wizard-header">
					<ul class="nav nav-pills">
						<li class="active"><a href="#tab1" data-toggle="tab">Noticias - NUEVO</a></li>
						
					</ul>
				</div>
				
<form action="noticias.php" method="post" enctype="multipart/form-data" onSubmit="$('#btn_guardar').html('Guardando ...')" name="wizard_form">
						...
						<div class="tab-pane active" id="tab1">
							...
							<div class="row">
								...
								<div class="col-md-6 col-md-offset-3">
									<p class="desc m-b-20">Noticias [Nuevo].</p>
...
<textarea type="text" name="texto" id="texto" class="form-control summernote" rows="6" ></textarea>
									</div>	

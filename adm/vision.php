...
if (isset($_POST["btn_editar"])){
		...
		$update=mysqli_query($link,"update _informativos set 
		 ...
		 rse_vision='".limpiar($link,$_POST["rse_vision"])."'
		where id=".$_POST["id"]."
			...
			<div id="rootwizard" class="wizard wizard-full-width">
				...
				<div class="wizard-header">
					<ul class="nav nav-pills">
						<li class="active"><a href="#tab1" data-toggle="tab">RSE - VISIÓN</a></li>
							...
							<div class="row">
								...
								<div class="col-md-6 col-md-offset-3">
									...
									<div class="form-group">
										<label class="control-label">RSE - VISIÓN</label>
										  <textarea     name="rse_vision"  class="form-control summernote"   style="height:350px"><?=$row1["rse_vision"]?></textarea>
									</div>

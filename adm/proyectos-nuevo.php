	...
	<div id="page-container" class="page-header-fixed page-sidebar-fixed">
		...
		<div id="content" class="content">
			...
			<ul class="breadcrumb">
				...
				<li class="active">Proyectos  [Nuevo]</li>
			</ul>
			...
			<div id="rootwizard" class="wizard wizard-full-width">
				...
				<div class="wizard-header">
					<ul class="nav nav-pills">
						<li class="active"><a href="#tab1" data-toggle="tab">Proyectos  - NUEVO</a></li>
						
					</ul>
				</div>
				
<form action="proyectos.php" method="post" enctype="multipart/form-data" onSubmit="$('#btn_guardar').html('Guardando ...')" name="wizard_form">
						...
						<div class="tab-pane active" id="tab1">
							...
							<div class="row">
								...
								<div class="col-md-7 col-md-offset-3">
									<p class="desc m-b-20">Proyectos  [Nuevo].</p>
...
<input required type="text" name="nombre" id="nombre" class="form-control" value="">
</div>	


<div class="form-group">
										<label class="control-label">Descripción</label>
<textarea type="text" name="descripcion" id="descripcion" class="form-control summernote" rows="6" ></textarea>
									</div>
...
<input  type="text" name="link_360" id="link_360" class="form-control" value="">
</div>	
...
<input  type="text" name="link_brochure" id="link_brochure" class="form-control" value="">
</div>	
...
<textarea type="text" name="metraje" id="metraje" class="form-control summernote" rows="6" ></textarea>
</div>	


<div class="form-group">
										<label class="control-label">Detalles</label>
<textarea type="text" name="detalles" id="detalles" class="form-control summernote" rows="6" ></textarea>
</div>	


<div class="form-group">
										<label class="control-label">Amenidades</label>
<textarea type="text" name="amenidades" id="amenidades" class="form-control summernote" rows="6" ></textarea>
</div>	

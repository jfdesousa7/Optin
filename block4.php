<?php   if($home["hide_bloque_4"]=="no"){?>
<section id="" class="" style="background-color:#FFF;padding:5% 0% 0% 0%">
            <div class="container">
                <div class="row "  >
                    <div class="col-lg-6 extracolumn1 texto_alig">
                        <p style="color: rgb(0, 0, 0); font-family: Raleway; font-size: 15px; line-height: 22.5px;"><?=$home["bloque_4_texto1"]?></p>
...
<span style="color: rgb(35, 31, 32);"><strong><?=$home["bloque_4_texto2"]?></strong></span>
</h2>
</div>
</div>
				 </div>
...
<?php  $cad=mysqli_query($link,"select * from bloque_4_items");
